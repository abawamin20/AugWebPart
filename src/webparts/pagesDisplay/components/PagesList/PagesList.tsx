...
import { DefaultButton, IColumn, Selection } from "@fluentui/react";
            ...
            <div className="d-flex align-items-center">
              {selectionDetails && selectionDetails.length > 0 && (
                <DefaultButton
                  onClick={() => {
                    window.open(
                      `${context.pageContext.web.absoluteUrl}${subscribeLink}?List=${listId}&Id=${selectionDetails[0].Id}`,
                      "_blank"
                    );
                  }}
                >
              ...
              {selectionDetails && selectionDetails.length > 0 && (
                <DefaultButton
                  onClick={() => {
                    window.open(
                      `${context.pageContext.web.absoluteUrl}${alertLink}?List=${listId}&Id=${selectionDetails[0].Id}`,
                      "_blank"
                    );
                  }}
                >
              ...
              {selectionDetails && selectionDetails.length > 0 && (
                <DefaultButton
                  onClick={() => {
                    window.open(
                      `${context.pageContext.web.absoluteUrl}${feedBackLink}?List=${listId}&Id=${selectionDetails[0].Id}`,
                      "_blank"
                    );
                  }}
                >
